...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (notificationType.equals("NgoPostNotification")){
        ...
        else if (notificationType.equals("NgoChatNotification")){
    ...
    private void showPostNotification(String pId, String pTitle, String pDescription) {
        ...
        Intent intent = new Intent(this, NgoPostActivity.class);
    ...
    private void sendNormalNotification(RemoteMessage remoteMessage) {
        ...
        Intent intent = new Intent(this, NgoChatActivity.class);
    ...
    private void updateToken(String tokenRefresh) {
        ...
        TokenActivity token = new TokenActivity(tokenRefresh);
