...
public class NgoRegisterActivity extends AppCompatActivity {
    ...
    TextView oldUserView, newPassView;
    Button registerButton, volunteerButton;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.ngo_register_activity);
        ...
        private void registerUSer(String email, final String password) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                               ...
                               // myDb.setEmail(emailTxt.getText().toString().trim());
                                myDb.setEmail(email);
                                myDb.setUid(uid);
                                ...
                                DatabaseReference reference = database.getReference("NgoUsers");
                                reference.child(uid).setValue(hashMap);()

                                FirebaseDatabase database = FirebaseDatabase.getInstance();
                                DatabaseReference ref = database.getReference("NgoLogs");
                                ref.push().child(uid).setValue(myDb);*/

                                Toast.makeText(NgoRegisterActivity.this, "You are now Registered " + user.getEmail(), Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(NgoRegisterActivity.this, NgoLoginActivity.class));
                                finish();
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(NgoRegisterActivity.this, "Could not Authenticate.", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(NgoRegisterActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
