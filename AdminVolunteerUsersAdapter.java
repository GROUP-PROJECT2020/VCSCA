...
public class AdminVolunteerUsersAdapter extends RecyclerView.Adapter<AdminVolunteerUsersAdapter.MyHolder> {
    ...
    public AdminVolunteerUsersAdapter(Context context,  int simple_list_item_1, List<AdminVolunteerUserModel> userList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.admin_volunteer_users_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int position) {
        ...
        try{
            Picasso.get().load(userImage).placeholder(R.drawable.person8).into(myHolder.mAvatarTv);
        }catch (Exception e){
            ...
            public void onClick(View view) {
                ...
                builder.setItems(new String[]{"Profile"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0) {
                            Intent intent = new Intent(context, VolunteerProfileLayoutActivity.class);
