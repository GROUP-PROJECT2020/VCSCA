 ...
 */
public class NgoUsersActivity extends AppCompatActivity {
    ProgressDialog progressDialog;
    RecyclerView recyclerView;
    NgoUsersAdapter adapterUsers;
    List<NgoUserModel> userList;
    FirebaseAuth firebaseAuth;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ngo_users_activity);

       // adapterUsers = new NgoUsersAdapter(NgoUsersActivity.this, userList);
        recyclerView = findViewById(R.id.users_rv);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(NgoUsersActivity.this));
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds: dataSnapshot.getChildren()){
                    NgoUserModel modelUser = ds.getValue(NgoUserModel.class);
                    //if(modelUser.getUid()!=null && modelUser.getUid().equals(fUser.getUid())){
                        userList.add(modelUser);
                    //}
                    adapterUsers = new NgoUsersAdapter(NgoUsersActivity.this, android.R.layout.simple_list_item_1, userList);
                    recyclerView.setAdapter(adapterUsers);
                }
            }
